...
//         var url = `https://apis.map.qq.com/ws/location/v1/ip?key=DFBBZ-OMN6J-UFLF7-DHZCF-IDQGT-3XFRD&output=jsonp`;
//         script.src = url;
...
//     try {
//         // 自定义文本和需要放的位置
//         document.getElementsByClassName("announcement_content").innerHTML =
